...
class AudioProcessor:
    ...
    def _apply_metadata_template(self, input_path: str, output_path: str, 
        ...
        try:
            ...
            # تطبيق الوسوم من القالب
            for tag_key, tag_value in template.items():
                if tag_value:
                    processed_value = self._process_template_value(tag_value, audio_info)
                    if processed_value:
    ...
    def _process_template_value(self, template_value: str, audio_info: Dict[str, Any]) -> str:
